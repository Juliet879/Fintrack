...
import com.julietgisemba.kipesa.model.ProfileOverview
import com.julietgisemba.kipesa.model.UserProfile
import com.julietgisemba.kipesa.navigation.Destinations
import com.julietgisemba.kipesa.ui.components.ProfileItemView
import com.julietgisemba.kipesa.ui.components.UserProfileItem
import com.julietgisemba.kipesa.viewmodel.FinanceViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ProfileScreen(navController1: NavHostController, viewModel: FinanceViewModel = hiltViewModel()) {
    val transactions by viewModel.transactions.collectAsState()
    val firebaseUser = FirebaseAuth.getInstance().currentUser
    val userName = firebaseUser?.displayName ?: "Guest"
    val userEmail = firebaseUser?.email ?: "guest@example.com"

    val totalBalance = transactions.filter { it.isIncome }
    ...
    val financeItems = listOf(
        ProfileOverview("Balance", "Total across accounts", totalBalance, Icons.Default.DateRange),
        ProfileOverview("Income", "This month", income, Icons.Default.ArrowForward),
        ProfileOverview("Expenses", "This month", expense, Icons.Default.ArrowBack)
    )
